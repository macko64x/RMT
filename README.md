# Thelma Hut — redmtnthelma.com

Static website for **redmtnthelma.com**. There is **no build step** — every file in this
repo is the site exactly as it deploys. Open `index.html` locally and it works.

Pages: `index.html` (Thelma Hut), `thelma-area-guide.html`, `guide-thelma.html` (off-grid guest guide — noindex, QR target), `terms.html`, `privacy.html`.
...
3. **Domain management** → add custom domain **redmtnthelma.com**; let Netlify handle SSL.
